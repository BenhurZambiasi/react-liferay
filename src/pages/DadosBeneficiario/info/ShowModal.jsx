...
export const ShowModal = ({ title, text, className, text_sucess, text_failure = "Voltar", onClose , onSave }) => {
    return (
        <div className="consulta-beneficiario-show-modal-container-backgorund position-fixed w-100 h-100 d-flex align-items-center justify-content-center">
            <div className={`consulta-beneficiario-show-modal-container position-absolute ${className}`}>
                <div className="position-relative w-100 d-flex flex-column">
                    <span onClick={onClose} className="material-symbols-outlined position-absolute">
                        close
                    </span>
                    <span className="consulta-beneficiario-show-modal-container-title mb-2">{title}</span>
                    <span
                    ...
                    <div className="w-100 gap-2 d-flex flex-column flex-sm-row align-items-center justify-content-end">
                        {text_sucess && (
                            <button className="consulta-beneficiario-show-modal-container-prosseguir d-flex align-items-center justify-content-center" onClick={onSave}>
